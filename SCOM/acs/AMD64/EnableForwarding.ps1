param ($collectorServerName)

if ($collectorServerName -eq $null)
{
    Write-Host "Usage: EnableForwarding.ps1 <CollectorName>"
    return
}

$enableAcsTask = Get-SCOMTask -Name 'Microsoft.SystemCenter.EnableAuditCollectionService'
$overrides = @{CollectorServer=$collectorServerName}
$credentials = Get-Credential

$healthServiceClass = Get-SCOMClass -Name 'Microsoft.SystemCenter.HealthService'
$healthServices = Get-SCOMClassInstance -Class $healthServiceClass

foreach($hs in $healthServices)
{
    "Enabling Audit Collection for " + $hs.DisplayName
    Start-SCOMTask -Task $enableAcsTask -Instance $hs -Override $overrides -TaskCredentials $credentials
}

# SIG # Begin signature block
# MIIdzQYJKoZIhvcNAQcCoIIdvjCCHboCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJ7adizLZks1xXXqpWu6gc2NF
# 0yugghhkMIIEwzCCA6ugAwIBAgITMwAAAJmqxYGfjKJ9igAAAAAAmTANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUyhepBJqlU2LGH3Rkw/unJKHWOIIwgYYGCisG
...
# AASCAQBMdIeAAshXkV4jB/u9a9niPTxtBnoZuOrBiAVibKB5tc2cj0nkbOXiFQmm
# 10q6lzydbDbX0hziG87HFqIrg1/yDEjYP/8HoSB49su9UVMOKFQLNxC9K66v6KJD
# ghK2mw4rXPUphdxQPGAYRpeyIGyU0EAsSrMSPRMME4nARsh/tdYhjjGsjgicmLvs
# 1KOoZug20oxha2+331BxzloRU43zUUoNv4ae7EegIii5/hO+92KzBI1pg3NHM+ot
# PnqWKGh5XNs2Ols6pqbNj035MyIqM8+oacwGGUERsSiCVbOq5iH79EH5a8eM0NK0
# 8uPpmkaVhgRBHeRnXYeZRJGwFZIpoYICKDCCAiQGCSqGSIb3DQEJBjGCAhUwggIR
...
# hkiG9w0BCQUxDxcNMTYwNzI3MTMwODA2WjAjBgkqhkiG9w0BCQQxFgQUoMsNDlXS
# UD9M5FpedBy5rXArZXgwDQYJKoZIhvcNAQEFBQAEggEAAQMZuJXLY4MKqJsD8oDF
# Rmj8C6dxHZSoCheiJrBzymcwFhlYsDx9fy8CVx69uzbwPT/JowE65a0YfjLJCe0l
# klpTTuz5r3I+HV6MNpF0OUeB5KpUG0O+oAVB40lkJUAp8GIZvVSndBtIKczCglA9
# 5ghGhwrse7D00Wo9UU2fuDDFUXEmN4T0/mNHM64+j4WJ6AEbOdWCEs8fN2JNFCN+
# R+zklbJ9Y1zi5f16z8LsipYJNvp/PdwMxIdCww81TA/cEAai4ccVmi39nZfg+MkZ
# ckZXXP69o/+rgBrYUtDv9/ytIx5ME2r7F8MYkUnyldI//dJq/V2nBwudItDbBoej
# CQ==
